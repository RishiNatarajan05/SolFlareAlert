#!/usr/bin/env python3
"""
Script to fetch 6 months of historical solar weather data
"""
...
# Change to backend directory for proper logging
...
def fetch_6months_data():
    ...
    print("=== FlareAlert 6-Month Data Fetch ===\n")
