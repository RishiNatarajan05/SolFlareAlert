#!/usr/bin/env python3
"""
Script to train solar weather prediction models with 6 months of data
"""
...
def train_6months_models():
    """Train the solar weather prediction models with 6 months of data"""
    print("=== FlareAlert 6-Month Model Training ===\n")
    
    # Initialize trainer
    trainer = ModelTrainer()
    
    # Define training period (last 6 months - optimal dataset size)
    ...
    try:
        ...
        print("\n=== 6-Month Training Completed Successfully! ===")
